...
//			}
	...
	public ProverExpr mkHornVariable(String name, ProverType type) {
		ProverExpr var = mkVariable(name, type);
		return var;
	}
...
//				System.out.println("Body -> " + body);
		...
		//	SpacerUtils su = new SpacerUtils();
			//su.fp_get_preds(this.fx);
		} catch (Exception e) {
			throw new RuntimeException(e.getMessage());
		}
...
// Some functions for outputing SMT-LIB
    ...
    public String getRules() {
    	...
    	sb.append("; Generated by JayHorn\n");
		try {
	    	BoolExpr[] rules;
			rules = this.fx.getRules();
			sb.append("; Number of rules:" + rules.length + "\n");
	    	sb.append(this.fx.toString(rules));
	    	return sb.toString();
		} catch (Z3Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();

...
//		try (FileOutputStream fileStream = new FileOutputStream(new File("prog.dot"));
//				OutputStreamWriter writer = new OutputStreamWriter(fileStream, "UTF-8");) {
//			DOTExporter<String, DefaultEdge> dot = new DOTExporter<String, DefaultEdge>(new StringNameProvider<String>(), null, null);
...
//		}
	...
	private Set<String> createdNestedDiamonds(DirectedGraph<String, DefaultEdge> graph, String src, String snk, int depth) {

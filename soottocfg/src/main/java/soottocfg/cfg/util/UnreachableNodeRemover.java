...
public class UnreachableNodeRemover<A, B extends DefaultEdge> {
	...
	/**
	 * Removes all nodes and edges from which the sink of the method is not reachable.
	 * Normally, all nodes and edges should be able to reach the sink. However, is we
	 * remove edges (e.g., when eliminating loops), this property might be violated and
	 * we have to re-establish it.
	 */
